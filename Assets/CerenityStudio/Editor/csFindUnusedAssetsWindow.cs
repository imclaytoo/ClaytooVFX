...
{
    public class csFindUnusedAssetsWindow : EditorWindow
    {
        csAssetCollector collection = new csAssetCollector();
        List<DeleteAsset> deleteAssets = new List<DeleteAsset>();
        Vector2 scroll;

        string searchTerm;

        [MenuItem("Cerenity Studio/Tools/Delete Unused Assets/Only Resource", false, 50)]
        static void InitWithoutCode()
        {
            var window = CreateInstance<csFindUnusedAssetsWindow>();
        ...
        [MenuItem("Cerenity Studio/Tools/Delete Unused Assets/Unused by Editor", false, 51)]
        ...
        [MenuItem("Cerenity Studio/Tools/Delete Unused Assets/Unused by Game", false, 52)]
        static void Init()
        {
            var window = CreateInstance<csFindUnusedAssetsWindow>();
        ...
        [MenuItem("Cerenity Studio/Tools/Delete Unused Assets/Clear cache")]
        static void ClearCache()
        {
            File.Delete(csAssetCollector.EXPORT_XMP_PATH);
            File.Delete(csClassReferenceCollection.XMP_PATH);
